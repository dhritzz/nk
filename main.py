...
if os.path.exists("config.json"):
    ...
    if invite_link == "" or invite_link == None:
        invite_link == "https://discord.gg/nekopoi"
...
@bot.event
async def on_ready():
    System.Title("Luna Nuker - Made By Pushy")
    System.Size(101, 15)
    Cursor.HideCursor()
    os.system('cls')
    print("\n\n\n")
...
async def nuke(ctx):
    ...
    await guild.create_text_channel("Luner Nuked You")
...
async def spamrole(ctx, name="EzNuke"):
    System.Title(f'Luner Nuker - Spamming Roles . . .')
    guild = ctx.guild
    await ctx.message.delete()
    amount = 50
